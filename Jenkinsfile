...
"""
    ...
    PROJECT_KEY = "bank-bookinfo-productpage"
    PROJECT_NAME = "bank-bookinfo-productpage"
  }
        ...
        container('jnlp') {
          ...
          script {
            ...
            scmVars = git branch: "${BRANCH_NAME}",
                          ...
                          url: 'git@github.com:bankhubjar/bookinfo-productpage.git'
          } // End script
        } // End container
      } // End steps
    } // End stage
            ...
            container('helm') {
                script {
                    ...
                    sh "helm template -f k8s/helm-values/values-bookinfo-${ENV_NAME}-productpage.yaml \
                        ...
                        --namespace bank-bookinfo-${ENV_NAME} bookinfo-${ENV_NAME}-productpage k8s/helm \
        ...
        container('docker') {
          script {
            ...
            docker.withRegistry('https://ghcr.io', 'Github_Registry') {
              ...
              docker.build('ghcr.io/bankhubjar/bookinfo-productpage:${ENV_NAME}').push()
